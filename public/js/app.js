...
var axios = __webpack_require__(/*! axios */ "./node_modules/axios/dist/browser/axios.cjs"); //same as "import axios from 'axios'"
...
function updateCart(currPizza) {
  axios.post('/update-cart', currPizza).then(function (res) {
...
addToCartBtn.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var currPizza = JSON.parse(btn.dataset.pizza);
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //copying the current order by value and creating an updated order
